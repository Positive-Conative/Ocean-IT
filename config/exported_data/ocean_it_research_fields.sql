...
CREATE TABLE `research_fields` (
  ...
  `field_picture` varchar(1500),  /*소제목, 사진갯수, 사진1.확장자 ...사진에 절대 /가 들어가면 안됨 */
  PRIMARY KEY (`rid`)
...
(1,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처'
  ...
  , "1/메인이미지/분산형 수중관측 제어망 개발1.jpg 
  /*1/수중 통신 알고리즘 개발/분산형 수중관측 제어망 개발2.jpg
  /*2/수중 통신 모뎀 보드 설계 및 제작(좌:수중센서노드, 우:수중통신모뎀)/분산형 수중관측 제어망 개발3.jpg/분산형 수중관측 제어망 개발4.jpg");
...
(2,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처'
  ...
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과'
  ,'2020-03-01','2020-03-06','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속'
  , '[{"size": 1, "title": "메인이미지", "img_name": "분산형 수중관측 제어망 개발1.jpg"}]
  ,[{"size": 1, "title": "수중 통신 알고리즘 개발", "img_name": "분산형 수중관측 제어망 개발2.jpg"}]
  ,[{"size": 2, "title": "수중 통신 모뎀 보드 설계 및 제작(좌:수중센서노드, 우:수중통신모뎀)", "img_name": "분산형 수중관측 제어망 개발3.jpg/분산형 수중관측 제어망 개발4.jpg"}]'
  );
  INSERT INTO `research_fields` VALUES 
(3,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(4,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(5,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(6,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(7,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(8,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2020-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");
  INSERT INTO `research_fields` VALUES 
(9,'한글과제명','영문과제명','한글사업명','영문사업명','한글부처','영어부처','한글주관기관','영문주관기관','한글지원기관','영문지원기관','한글참여기관','영문참여기관'
  ,'한글연구목표','영문연구목표','한글연구내용','영문연구내용','한글기대성과','영문기대성과','2020-03-01','2021-03-08','연구책임자(한글)','연구책임자(영문)','한글소속','영문소속', "그림3.jpg");