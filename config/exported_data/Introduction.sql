...
INSERT INTO `introduction` VALUES (23,'2014.12','제1회 해양과학기술정책포럼(해양보전 및 복원과 ICT 기술)','1st Marine Science and Technology Policy Forum (Marine Conservation and Restoration and ICT Technology)','포럼 주최','etc영어');
INSERT INTO `introduction` VALUES (24,'2014.10','해양수산부 ‘분산형 수중관측제어망 개발’ 기획연구 주관 기관 선정','내용영어','국책연구개발 사업','Forum Hosted');
